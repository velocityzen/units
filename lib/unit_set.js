...
UnitSet.prototype.alias = function(key, srcKey) {
  return this._add(key, this.units[srcKey]);
};
...
UnitSet.prototype.addSet = function(key, unitSet, parentKey) {
  ...
  if (key && !this.units[key]) {
    this.units[key] = new UnitInfo(null, unitSet);
  }
};
